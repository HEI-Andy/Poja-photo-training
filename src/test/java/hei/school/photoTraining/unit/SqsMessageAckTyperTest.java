package hei.school.photoTraining.unit;
...
import hei.school.photoTraining.endpoint.event.EventConsumer;
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent =
        new EventConsumer.TypedEvent(
            "hei.school.photoTraining.endpoint.event.gen.UuidCreated", payload);
